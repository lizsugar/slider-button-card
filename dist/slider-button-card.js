...
class Controller {
    ...
    get disableSliding() {
        var _a, _b;
        return (_b = (_a = this._config.slider) === null || _a === void 0 ? void 0 : _a.disable_sliding) !== null && _b !== void 0 ? _b : false;
    }
    get toggleValue() {
...
class LightController extends Controller {
    ...
    get hasToggle() {
        ...
        return (_f = (_e = this._config.slider) === null || _e === void 0 ? void 0 : _e.disable_sliding) !== null && _f !== void 0 ? _f : false;
    }
    get hasSlider() {
        var _a, _b;
        if (!this.stateObj) {
...
let SliderButtonCardEditor = class SliderButtonCardEditor extends LitElement {
    ...
    get _show_attribute() {
        var _a, _b;
        return typeof ((_a = this._config) === null || _a === void 0 ? void 0 : _a.show_attribute) === 'undefined' ? true : (_b = this._config) === null || _b === void 0 ? void 0 : _b.show_attribute;
    }
    get _compact() {
        var _a, _b;
    ...
    get _attribute() {
        var _a;
        return ((_a = this._config) === null || _a === void 0 ? void 0 : _a.attribute) || '';
    }
    get _icon() {
        var _a;
